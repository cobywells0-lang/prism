The base character stats are Finesse, Agility, Physique, Instinct, Intelligence and Soul. The minimum value a stat can normally have is +1, and the maximum is +5. Each stat is associated with three Skills. When you roll for a Skill, you use the bonus of the associated stat - if you are proficient in that skill, you add your Proficiency bonus.

### Finesse
A character’s ability to perform fine motions and act with precision. Finesse is needed to use delicate tools like lockpicks, perform the fine motions required for some types of spellcasting, or make attacks using ranged or precision weapons. Finesse also increases the extra damage you deal on a Critical Hit.

- **Sleight.** Performing a dextrous task subtly and unseen, like palming a small object or picking a pocket.
...
- **Stealth.** Avoiding detection, like hiding in darkness or blending into a crowd.
...
- **Perception.** Noticing subtle details, like spotting a stalking foe or finding a hidden object.
- **Survival.** Navigating and exploiting the environment, like tracking prey or maintaining a bearing through harsh weather.
- **Insight.** Reading the intentions of others, like realising a creature has hostile intentions early or noticing when someone is trying to deceive you.

### Intelligence
A character’s ability to learn and retain complex information. Intelligence is needed to design items, spin lies, perform rituals or recall esoteric information. Intelligence also grants bonus Proficiencies.

- **Deception.** Misleading someone, like crafting a robust lie or twisting the narrative.
